...
import {
  getContentSettingsPlaceholder,
  getCoverInheritanceSource,
  getVideoInheritanceSource,
} from "@elysium/composables/content-settings-display";
...
export default Component.wrapComponentConfig({
  ...
  computed: {
    ...
    currentCoverInheritanceSource() {
      return getCoverInheritanceSource(
        this.slide,
        this.currentCoverIdKey,
