...
**Changelog**
- Verified compatibility with Shopware 6.7.13.x
...
**Changelog**
- Added "Slides per group" option to the Elysium Slider CMS element. This allows configuring how many slides are scrolled per navigation step
...
- Added time-control support for Elysium CMS sections and blocks (technical preview). Elysium sections and blocks can now be scheduled with start and end dates to automatically appear and disappear from the storefront
...
**Changelog**
- Added Elasticsearch support for slide search in administration (technical preview)
...
**Changelog**
- Fixed Shopware 6.7 migration compatibility for product foreign key references
- Added composite constraint key to Migration1706795531 for fresh installations
