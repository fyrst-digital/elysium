...
- Händler können an einem Slider eine Pause- und Play-Schaltfläche anzeigen. Sie bleibt ausgeblendet, bis sie eingeschaltet wird
...
**Changelog**
- Kompatibilität mit Shopware 6.7.13.x geprüft
