...
- Fehler behoben, bei dem die Live-Vorschau keine Kategorie- oder Produktdaten anzeigte, wenn ein Verlinkungstyp beim ersten Mal auf einem neuen Slide gesetzt wurde
- Die Produktauswahl in den Slide-Verlinkungseinstellungen zeigt nun nur noch aktive Produkte an
...
- Zeitsteuerung für Elysium CMS Sektionen und Blöcke hinzugefügt (Technische Vorschau). Elysium Sektionen und Blöcke können nun mit Start- und Enddatum geplant werden, um automatisch im Storefront angezeigt und ausgeblendet zu werden
...
- Slide-Name Validierung hinzugefügt. Slide-Namen erlauben nur Buchstaben, Zahlen, Leerzeichen und Bindestriche. Leerzeichen am Anfang oder Ende werden abgelehnt
...
- `ElysiumCmsSlidesResultEvent` wurde entfernt. Stattdessen kann `ElysiumSlidesResultEvent` verwenden
- Korrektur der Position-Einstellung in der Slider Navigation
...
**Changelog**
- Ein Darstellungsproblem in der Erlebniswelten Sidebar wurde behoben
