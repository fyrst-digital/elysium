...
class SlideValidationSubscriberTest extends TestCase
{
    ...
    // =====================================================
    // CMS Section Time Control Validation Tests
    // =====================================================

    public function testCmsSectionSkipsNonElysiumType(): void
    {
        $command = new CmsSectionTestWriteCommand('create', [
            'type' => 'default',
    ...
    #[DataProvider('validDateRangeProvider')]
    public function testCmsSectionValidatesWithValidDates(string $activeFrom, string $activeUntil): void
    {
        $command = new CmsSectionTestWriteCommand('create', [
            'type' => Defaults::CMS_SECTION_NAME,
            'custom_fields' => \json_encode([
                Defaults::CMS_SECTION_SETTINGS_KEY => [
    ...
    #[DataProvider('invalidDateRangeProvider')]
    public function testCmsSectionThrowsViolationOnInvalidRange(string $activeFrom, string $activeUntil): void
    {
        $command = new CmsSectionTestWriteCommand('create', [
            'type' => Defaults::CMS_SECTION_NAME,
            'custom_fields' => \json_encode([
    ...
    public function testCmsSectionAllowsNoCustomFields(): void
    {
        $command = new CmsSectionTestWriteCommand('create', [
            'type' => Defaults::CMS_SECTION_NAME,
        ]);
    ...
    public function testCmsSectionSkipsDelete(): void
    {
        $command = new CmsSectionTestWriteCommand('delete', [
            'type' => Defaults::CMS_SECTION_NAME,
            'custom_fields' => \json_encode([
                Defaults::CMS_SECTION_SETTINGS_KEY => [
                    'activeFrom' => '2025-12-31 23:59:59',
    ...
    public function testCmsSectionUpdateMergesExistingActiveUntil(): void
    {
        $id = Uuid::randomHex();
        $command = new CmsSectionTestWriteCommand('update', [
            Defaults::CMS_SECTION_SETTINGS_KEY => [
                'activeFrom' => '2025-01-01 00:00:00',
            ],
        ], $id);
    ...
    public function testCmsSectionUpdateThrowsViolationWhenNewActiveFromAfterExistingActiveUntil(): void
    {
        $id = Uuid::randomHex();
        $command = new CmsSectionTestWriteCommand('update', [
            Defaults::CMS_SECTION_SETTINGS_KEY => [
    ...
    public function testCmsSectionUpdateWithBothFieldsProvidedSkipsDatabaseFetch(): void
    {
        $id = Uuid::randomHex();
        $command = new CmsSectionTestWriteCommand('update', [
            Defaults::CMS_SECTION_SETTINGS_KEY => [
    ...
    // =====================================================
    // CMS Block Time Control Validation Tests
    // =====================================================

    public function testCmsBlockSkipsNonElysiumType(): void
    {
        $command = new CmsBlockTestWriteCommand('create', [
            'type' => 'text',
            'custom_fields' => \json_encode([
    ...
    #[DataProvider('elysiumBlockTypeProvider')]
    public function testCmsBlockValidatesWithValidDates(string $blockType): void
    {
        $command = new CmsBlockTestWriteCommand('create', [
            'type' => $blockType,
            'custom_fields' => \json_encode([
    ...
    public static function elysiumBlockTypeProvider(): array
    {
        return [
            'banner block' => ['blur-elysium-banner'],
            'slider block' => ['blur-elysium-slider'],
        ];
    }

    public function testCmsBlockThrowsViolationOnInvalidRange(): void
    {
        $command = new CmsBlockTestWriteCommand('create', [
    ...
    public function testCmsBlockAllowsNoCustomFields(): void
    {
        $command = new CmsBlockTestWriteCommand('create', [
            'type' => 'blur-elysium-banner',
        ]);
    ...
    public function testCmsBlockSkipsDelete(): void
    {
        $command = new CmsBlockTestWriteCommand('delete', [
            'type' => 'blur-elysium-slider',
            'custom_fields' => \json_encode([
                Defaults::CMS_BLOCK_ADVANCED_KEY => [
                    'activeFrom' => '2025-12-31 23:59:59',
    ...
    public function testCmsBlockUpdateMergesExistingActiveUntil(): void
    {
        $id = Uuid::randomHex();
        $command = new CmsBlockTestWriteCommand('update', [
            Defaults::CMS_BLOCK_ADVANCED_KEY => [
                'activeFrom' => '2025-01-01 00:00:00',
            ],
        ], $id);
    ...
    public function testCmsBlockUpdateThrowsViolationWhenNewActiveFromAfterExistingActiveUntil(): void
    {
        $id = Uuid::randomHex();
        $command = new CmsBlockTestWriteCommand('update', [
            Defaults::CMS_BLOCK_ADVANCED_KEY => [
    ...
    public function testCmsBlockFeatureFlagDisabledSkipsValidation(): void
    {
        Feature::resetRegisteredFeatures();
        Feature::registerFeatures([
            'elysium_preview_time_control' => ['default' => false],
        ]);
    ...
    public function testCmsBlockUpdateSkipsWhenNoSettingsKey(): void
    {
        $command = new CmsBlockTestWriteCommand('update', [
            'some_other_field' => 'value',
        ]);
 ...
 * @internal
 */
class CmsSectionTestWriteCommand extends WriteCommand
{
    private string $privilegeType;
    protected array $payload;
    protected array $primaryKey;
    ...
    public function __construct(string $privilegeType, array $payload, string $id = '')
    {
        ...
        $this->payload = $payload;
        $this->primaryKey = ['id' => $id ?: Uuid::randomHex()];
        $this->entityName = 'cms_section';
        $this->existence = new EntityExistence('cms_section', [], false, false, false, []);
        $this->path = '';
    }
 ...
 * @internal
 */
class CmsBlockTestWriteCommand extends WriteCommand
{
    private string $privilegeType;
    protected array $payload;
    protected array $primaryKey;
    ...
    public function __construct(string $privilegeType, array $payload, string $id = '')
    {
        ...
        $this->payload = $payload;
        $this->primaryKey = ['id' => $id ?: Uuid::randomHex()];
        $this->entityName = 'cms_block';
        $this->existence = new EntityExistence('cms_block', [], false, false, false, []);
        $this->path = '';
    }
